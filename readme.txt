...
- Easy to customize the UI: choose themes from the plugin settings.
...
1. Upload `hipmob-wordpress.zip` to the `/wp-content/plugins/` directory.
2. Activate the plugin through the 'Plugins' menu in WordPress.
3. Configure the Hipmob plugin via the Settings menu.
4. Use the [hipmob_enabled] shortcode to add Hipmob live chat to any particular page or post, or enable it on every page from from the settings menu.
...
= 1.7.5 =
Option to change the tab offset pixel size from the default of 100. This moves it closer or farther away from the left or right as required.
